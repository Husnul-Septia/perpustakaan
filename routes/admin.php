...
Route::put('borrow/{borrowHistory}/return', 'BorrowController@return_book')->name('borrow.return');

Route::get('report/top_book', 'ReportController@top_book')->name('report.top_book');
Route::get('report/top_user', 'ReportController@top_user')->name('report.top_user');